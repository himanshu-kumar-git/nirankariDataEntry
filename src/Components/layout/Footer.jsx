...
export default function Footer() {
  return (
    <footer className="text-gray-100 body-font bg-gray-500">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-gray-950 tracking-widest text-sm mb-3">
              CATEGORIES
            </h2>
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-100 hover:text-gray-800">Home</a>
              </li>
              <li>
                <a className="text-gray-100 hover:text-gray-800">Order</a>
              </li>
              <li>
              ...
              <li>
                <a className="text-gray-100 hover:text-gray-800">Cart</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
